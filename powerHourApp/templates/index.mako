            ...
            <div id="wrapper">
                <div id="content">
                    ...
                    <div id="center1"> <h2> Music Here </h2>
                        <h3> Genre Title </h3>
                        % if result:
                            <iframe src="https://embed.spotify.com/?uri=spotify:user:1245851618:playlist:${result.uri}" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>
                        % else:
                            <iframe src="https://embed.spotify.com/?uri=spotify:user:1245851618:playlist:1BPrQD0h4xLZ3vHvCKlCbf" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>
                        % endif
                    </div>
